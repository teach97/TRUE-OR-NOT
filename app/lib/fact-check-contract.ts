...
export type FactCheckRequest = { text: string; focus: string; consent: true; modelPreference: ModelPreference; linkUrl?: string | null; image?: AttachedImage | null; jevMode?: boolean | null };
