...
// Adapted from React Bits BellToggle (https://reactbits.dev/c/micro/bell-toggle,
// source: https://github.com/DavidHDev/react-bits/blob/main/src/ts-default/Micro/BellToggle/BellToggle.tsx).
// The Hugeicons bell is intentionally not bundled; pass `icon` to restore it.
