...
// Adapted from React Bits SquishSwitch (https://reactbits.dev/c/micro/squish-switch,
// source: https://github.com/DavidHDev/react-bits/blob/main/src/ts-default/Micro/SquishSwitch/SquishSwitch.tsx).
import {
  useEffect,
  useId,
  useRef,
